...
from app.models.request_model import CoachingRequest
...
async def connect_to_mongo():
    ...
    try:
        ...
        await init_beanie(
            ...
            document_models=[User, ProfessionalProfile, MealLog, Recipe, Plan, CoachingRequest]
        )
        ...
        logger.info(f"✅ Beanie inicializado con {len([User, ProfessionalProfile, MealLog, Recipe, Plan, CoachingRequest])} modelos")
