...
export default function ProfileSelectionScreen({ navigation }) {
  ...
  const handleProfileSelect = (profileType) => {
    ...
    if (profileType === 'client') {
      // Flujo de 5 pasos para clientes
      navigation.navigate('RegisterStep1', { profileType: profileType });
    } else {
      // Pantalla de registro directo para profesionales (Coach/Nutriólogo)
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.9}
          onPress={() => handleProfileSelect('client')}
        >
        ...
        <TouchableOpacity 
          style={styles.card} 
          activeOpacity={0.9}
          onPress={() => handleProfileSelect('coach')}
        >
        ...
        <TouchableOpacity 
          style={styles.card} 
          activeOpacity={0.9}
          onPress={() => handleProfileSelect('nutritionist')}
        >
